...
function Strategy(options, verify) {
  ...
  options.authorizationURL = options.authorizationURL || url.resolve(this._baseURL, 'apps/oauth2/authorize');
  options.tokenURL = options.tokenURL || url.resolve(this._baseURL, 'apps/oauth2/api/v1/token');
